...
const Page = async ({ params }: { params: { id: string } }) => {
  ...
  return (
    <div className='mx-20 my-10 page-container'>
      <div className='flex w-full text-left'>
        <Link href="/manage/recipes" className='flex items-center justify-center gap-2 ml-24'>
      ...
      <div>
        <p className='text-2xl font-bold'>Recipe Information</p>
      </div>tailw
      <SubmissionCard
        id={recipe._id}
        name={recipe.name}
