export const mealLinks: { name: string; path: string, image: string, }[] = [
  { name: "Breakfast", path: '/meals/breakfast', image: '/assets/meals/breakfast.png' },
...
export const MEAL_DESCRIPTIONS: { [key in MealName]?: string } = {
  [MealName.BREAKFAST]: "Kickstart your day with Breakfast: A collection of morning delights that energize and inspire.",
