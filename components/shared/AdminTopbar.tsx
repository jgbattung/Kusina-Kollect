...
function AdminTopbar() {
  return (
    <div className='w-full bg-white flex items-center justify-between px-8 py-6'>
      <div className='flex items-center justify-center gap-3'>
        ...
        <div className='flex flex-col'>
          ...
          <p className='font-light text-xs'>Manage Kusina Kollect with the available admin tools</p>
        </div>
      </div>
      <div>
